...
Before doing ANY planning or implementation work, you MUST read all files in the `.claude/docs/godot` folder. This is non-negotiable. Use the appropriate file reading tools to:
1. List all files in `.claude/docs/godot`
...
1. First, confirm you've read the .claude/docs/godot folder contents
...
- [ ] Documentation in .claude/docs/godot has been read and considered
...
- Reference specific documentation from .claude/docs/godot when it influences your choices
...
- If .claude/docs/godot doesn't exist or is empty, inform the user and ask if they have documentation elsewhere
